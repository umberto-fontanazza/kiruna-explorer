...
export const newDocuments = [
  ...
  },
  {
    ...
    type: DocumentType.Prescriptive,
    stakeholders: [Stakeholder.KirunaKommun],
    scale: { type: ScaleType.ArchitecturalScale }
  ...
  } , 
  {
    ...
    description: "The third Detailed Plan of the second demolition phase covers a narrow, elongated area straddling the old railway. Like all areas within the 'Gruvstadpark 2' zone, its sole designated land use is for mining activities, although it will temporarily be used as a park during an interim phase.",
  ...
  
  {
    ...
    stakeholders: [Stakeholder.Lkab],
    scale: { type: ScaleType.Text },
    coordinates: { latitude:67.8569, longitude: 20.2530},
  ...
  },
  {
    ...
    stakeholders: [Stakeholder.Lkab],
    scale: { type: ScaleType.BlueprintsOrEffect },
    coordinates: { latitude:67.5109, longitude:20.1320},
  },
  {
  ...
  },
  {
    ...
    stakeholders: [Stakeholder.Lkab],
    scale: { type: ScaleType.ArchitecturalScale },
    coordinates: { latitude:67.8510, longitude: 20.2290},
  ...
  },
  {
    ...
    stakeholders: [Stakeholder.KirunaKommun, Stakeholder.WhiteArkitekter],
    scale: { type: ScaleType.ArchitecturalScale },
    coordinates: { latitude:67.8508, longitude: 20.3050},
  },
  {
  ...
  
  {
    ...
    description: "This document outlines Kiruna's efforts to shift to renewable energy sources, including solar and wind farms to meet urban energy demands.",
    issuanceTime: "2024-02",
    type: DocumentType.Technical,
    stakeholders: [Stakeholder.KirunaKommun, Stakeholder.Lkab],
    scale: {type: ScaleType.Text },
    coordinates: { latitude: 67.8562, longitude: 20.3120 },
  },
  {
    title: "Construction of Hospital Complex",
    description: "The hospital complex includes advanced medical facilities, emergency care, and green building features to serve the relocated population.",
  ...
  },
  {
    ...
    description: "This document summarizes feedback gathered from residents regarding the urban transformation plans and future projects.",
  ...
  },
  {
    ...
    description: "A detailed proposal for realigning the railway infrastructure to facilitate better transportation access and minimize disruption.",
  ...
  },
  {
    ...
    description: "This document provides the architectural blueprint for a new residential area with integrated public spaces and amenities.",
    issuanceTime: "2023-08",
    type: DocumentType.Design,
  ...
  },
  {
    ...
    description: "Guidelines for protecting biodiversity in Kiruna's green areas during urban and mining developments.",
  ...
  },
  {
    ...
    description: "A technical analysis of sustainable water resource management, including new drainage systems for the relocated city.",
  ...
  },
  {
    ...
    description: "This document marks the beginning of the cultural center's construction, housing exhibition spaces and public event areas.",
  ...
  },
  {
    ...
    description: "Design and implementation plan for expanding key roads to accommodate increased traffic in new urban zones.",
  ...
  description: "A design initiative to build affordable housing units for low-income residents, ensuring accessibility and sustainability.",
  ...
  },
  {
   ...
   description: "A relocation strategy for heritage buildings, including logistics and timelines for safely moving structures of cultural significance.",
   issuanceTime: "2023-04",
   type: DocumentType.Technical,
   stakeholders: [Stakeholder.WhiteArkitekter, Stakeholder.KirunaKommun],
   scale:{ type: ScaleType.BlueprintsOrEffect },
   coordinates: { latitude: 67.8550,longitude: 20.2808 },
  },
  {
   title: "Public Park Development",
   description: "This plan outlines the design and construction of a large public park with recreational and green areas for the community.",
   issuanceTime: "2024-01",
   type: DocumentType.MaterialEffect,
   stakeholders: [Stakeholder.KirunaKommun],
   scale: { type: ScaleType.ArchitecturalScale },
   coordinates: { latitude: 67.8590, longitude: 20.3133 },
  },
  {
    title: "Noise Pollution Control Measures",
    description: "Technical guidelines for reducing noise pollution in residential and public areas affected by mining activities.",
  ...
  },
  {
    ...
    description: "Prescriptive measures for improving safety standards in public spaces, including lighting and security installations.",
  ...
  },
 {
    ...
    description: "A prescriptive plan introducing a smart waste management system in Kiruna, including automated waste sorting and underground container networks for better efficiency.",
    ...
    },
    {
      ...
      description: "This project outlines the implementation of free public Wi-Fi across key public spaces in the new Kiruna city center, promoting digital accessibility for residents and visitors.",
      issuanceTime: "2023-12",
      type: DocumentType.Technical,
    ...
    },
    {
      ...
      description: "A design plan promoting the construction of green rooftops on public and residential buildings to improve urban air quality and energy efficiency.",
    ...
    },
    {
      ...
      description: "A technical document analyzing energy storage solutions, including battery systems, to support the city's transition to renewable energy sources.",
    ...
    },
    {
      ...
      description: "A prescriptive plan addressing winter safety in Kiruna through improved snow removal techniques, heated pedestrian paths, and anti-slip road materials.",
      issuanceTime: "2024-01",
      type: DocumentType.Prescriptive,
      stakeholders: [Stakeholder.KirunaKommun],
      scale: { type: ScaleType.BlueprintsOrEffect },
